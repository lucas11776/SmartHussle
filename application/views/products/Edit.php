                    ...
                    <?= form_open_multipart(uri_string(), ['class' => 'row pt-3 col-md-8 col-lg-6 offset-md-2 offset-lg-3']) ?>
                        ...
                        <div class="form-group col-12">
                            ...
                            <select type="text"
                                    ...
                                    id="category">
                                <option value="<?= set_value('category') ? set_value('category') : $product['category'] ?>">
                                    <?= set_value('category') ? set_value('category') : $product['category'] ?>
                                </option>
                                <?php for($i = 0; $i < count($categories); $i++): ?>
                                    <?php if ($categories[$i]['slug'] != $product['category']): ?>
